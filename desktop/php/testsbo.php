    ...
    <div class="col-lg-10 col-md-9 col-sm-8 eqLogicThumbnailDisplay" style="border-left: solid 1px #EEE; padding-left: 25px;">
      ...
      <legend><i class="fa fa-cog"><!-- Icone engrenage--></i>  {{Gestion}}</legend><!-- Titre de la section de gestions-->
        <div class="eqLogicThumbnailContainer"><!-- Div de la section gestion-->
          ...
          <div class="cursor eqLogicAction" data-action="gotoPluginConf" style="text-align: center; background-color : #ffffff; height : 120px;margin-bottom : 10 px;padding : 5px;border-radius: 2px;width : 160px;margin-left : 10px;"><!-- Div pour ouvrir le modal configuration du plugin-->
                  ...
                  <form class="form-horizontal">
                      <fieldset>
                          <div class='sendMode sendmail' style="display: none;">
                              <div class="alert alert-danger">Attention cette option nécessite d'avoir correctement configurer le système (OS).
                              </div>
                          </div>
...
<?php 
    include_file('desktop', 'testsbo', 'js', 'testsbo');
